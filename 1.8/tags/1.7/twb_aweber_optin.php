...
function twb_admin_notice() {
	...
	if ( ! get_user_meta($user_id, 'twb_update_notice') ) {
        ...
        printf(__('PRO Version of Simple Aweber Optin Widget is also available. <a href="http://plugins.theweb-designs.com/simple-aweber-optin-widget/" target="_blank">Click Here to Purchase it and Unlock All features!</a> | <a href="%1$s">Hide Notice</a>'), '?twb_update_notice=0');
        echo "</p></div>";
	}
}
