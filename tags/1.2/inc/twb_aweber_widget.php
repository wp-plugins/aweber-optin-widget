...
class twb_aweber_optin_widget extends WP_Widget {
	...
	<script>
        ...
        <?php 
			...
			<input class="twb_email" id=""  type="email" name="email" placeholder=" '. $twb_ph_email. '" minlength=3 required  />';
			}else {
			$output .='<input class="twb_email" id="" type="email" name="email" placeholder=" '. $twb_ph_email. '" minlength=3 required />';
			}
			$output .='<input name="submit" style="background:' .$twb_ph_btn_color. '; color:' .$twb_ph_btn_txt_color. '; margin:5px 0; padding:15px;" class="twb_btn" type="submit" value="' .$twb_ph_btn. '" tabindex="502" />
	...
	public function form( $instance ) {
		...
		jQuery(document).ready(function() {
			// colorpicker field
			jQuery('.twb_btn_color, .twb_btn_txt_color').each(function(){
			var $this = jQuery(this),
			id = $this.attr('rel');
			$this.farbtastic('#' + id).hide();
				jQuery('.twb, .twb-title').click(function(){jQuery('.twb_btn_color').fadeIn('medium').siblings("div").hide();});
				jQuery('.twb-btn-txt-color, .twb-btn-txt-color-title').click(function(){jQuery('.twb_btn_txt_color').fadeIn('medium').siblings("div").hide();});
			});
		});
		</script>
    ...
    <a href="http://theweb-designs.com/plugins/" target="_blank" title="Buy Pro Version"><h2>Buy Pro Version!</h2></a>
    <div style="clear:both; padding-bottom:30px;"></div>
  	<a href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=AEBXZCEYG3DQC" target="_blank"><img src="https://www.paypalobjects.com/en_US/i/btn/btn_donateCC_LG.gif" border="0" name="submit" alt="PayPal - The safer, easier way to pay online!" /></a>
	<div style="clear:both; padding-bottom:10px;"></div>
	<?php }
