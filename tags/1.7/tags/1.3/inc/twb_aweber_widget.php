...
class twb_aweber_optin_widget extends WP_Widget {
	...
	<script>
        ...
        <?php 
			...
			$output .='<input type="text" id="" name="name" placeholder="' .$twb_ph_name. '"class="twb_name" value="" />
	...
	public function form( $instance ) {
		$instance = wp_parse_args( (array) $instance, array( 
			...
			'twb_sub_title' => '<p style="font-size:20px; text-align:center;">Enter Your Email Below to Get Started!</p>',
			'twb_list_name' => '',
			'twb_ty_link' => '',
			'twb_name_check' => 'off',
